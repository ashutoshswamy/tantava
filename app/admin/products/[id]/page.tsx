  ...
  return (
    <div className="p-8 text-white max-w-3xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="font-headline-lg text-[28px] text-white">Edit Product</h1>
      </div>
        ...
        <div className="bg-[#1a1a1a] border border-white/5 rounded-xl p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white font-body-md text-[14px] focus:border-[#C9A84C]/50 focus:outline-none transition-colors resize-none"
            />
          </div>
