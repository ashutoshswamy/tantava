  ...
  return (
    <div className="max-w-3xl p-4 sm:p-6 lg:p-8 text-[#2b0e0a]">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-[26px] font-bold text-[#2b0e0a] tracking-tight">New Collection</h1>
          <p className="text-[#8c6f52] text-[13px] mt-0.5">Create a new collection to group products</p>
        </div>
      </div>
        ...
        <div className="bg-white border border-[#efdcb0] rounded-2xl p-5 sm:p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. bridal-collection"
            />
            <p className="text-[#dcc9a0] text-[11px] mt-1">Used in the URL: /collections/{form.slug || "..."}</p>
          </div>
